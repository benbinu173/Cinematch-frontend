...
function AdminRegister() {
  ...
  return (
        <div className="adminreg-bg d-flex justify-content-center align-items-center min-vh-100">
          ...
          <div className="container w-75 shadow-lg p-4 rounded-4" style={{ background: "rgba(255, 255, 255, 0.9)" }}>
            ...
            <div className="rounded-4 position-relative overflow-hidden" style={{ height: "60vh", backgroundImage: "url(https://www.zacharyxavier.com/content/images/2022/01/2001.jpg)", backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundPosition: "center" }}>
              ...
              <div className="d-flex justify-content-center align-items-center position-relative">
                ...
                <div className="col-md-6">
                  <form className="p-4 rounded-4" style={{ background: "rgba(255, 255, 255, 0.8)" }}>
                    ...
                    <p className='text-danger text-end mt-1'><Link to ="/adminlogin">Already a user? Click HERE!</Link></p>
                  </form>
                </div>
              </div>
